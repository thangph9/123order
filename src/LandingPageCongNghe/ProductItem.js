            ...
            <div className="col-md mt-2 px-2" style={{display:display,marginBottom:'8px',flexGrow:0}}>
                <div className="card" style={{width:'212px',height:'340px'}}>
                    ...
                    <div className="card-body p-2">
                        ...
                        <br/>
                        <strong className="card-text align-left deal-price mb-2" style={{width: '97px',fontSize: '12px',fontFamily:'Arial,Helvetica,sans-serif'}}>{Math.round(priceCurrency)} VNĐ</strong>
                        <span className="card-text align-right deal-old-price"><s style={{fontSize:'12px'}}>{Math.round(base_priceCurrency)} VNĐ</s></span>
