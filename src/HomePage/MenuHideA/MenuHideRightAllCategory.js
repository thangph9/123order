...
class MenuHideRightAllCategory extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="allCategoryA" className="tabcontent" style={{ display: 'none' }}>
  ...
  <div className="col-md-8">
    <div className="row">
      <div className="col-md-12 gia-soc-title">
        ...
        <span className="ml-2">TOÀN BỘ DANH MỤC</span>
      </div>
    </div>
...
const connected = connect(mapStateToProps)(MenuHideRightAllCategory);
export { connected as MenuHideRightAllCategory } 