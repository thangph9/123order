...
class MenuHideRightTheThao extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="theThaoA" className="tabcontent" style={{ display: 'none' }}>
  ...
  <div className="col-md-8">
    <div className="row">
      <div className="col-md-12 gia-soc-title">
        ...
        <span className="ml-2">ĐỒ THỂ THAO</span>
      </div>
    </div>
...
const connected = connect(mapStateToProps)(MenuHideRightTheThao);
export { connected as MenuHideRightTheThao } 