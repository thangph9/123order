...
class MenuHideRightGiaDinh extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="giaDinhA" className="tabcontent" style={{ display: 'none' }}>
  ...
  <div className="col-md-8">
    <div className="row">
      <div className="col-md-12 gia-soc-title">
        ...
        <span className="ml-2">GIA ĐÌNH VÀ NHÀ VƯỜN</span>
      </div>
    </div>
...
const connected = connect(mapStateToProps)(MenuHideRightGiaDinh);
export { connected as MenuHideRightGiaDinh } 