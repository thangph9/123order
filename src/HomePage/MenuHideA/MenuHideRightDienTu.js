...
class MenuHideRightDienTu extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="dienTuA" className="tabcontent" style={{ display: 'none' }}>
  ...
  <div className="col-md-8">
    <div className="row">
      <div className="col-md-12 gia-soc-title">
        ...
        <span className="ml-2">ĐIỆN TỬ VÀ CÔNG NGHỆ</span>
      </div>
    </div>
...
const connected = connect(mapStateToProps)(MenuHideRightDienTu);
export { connected as MenuHideRightDienTu } 