...
class MenuHideRightCongNghiep extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="congNghiepA" className="tabcontent" style={{ display: 'none' }}>
...
const connected = connect(mapStateToProps)(MenuHideRightCongNghiep);
export { connected as MenuHideRightCongNghiep } 