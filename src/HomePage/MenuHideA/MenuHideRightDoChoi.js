...
class MenuHideRightDoChoi extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="doChoiA" className="tabcontent" style={{ display: 'none' }}>
  ...
  <div className="col-md-8">
    <div className="row">
      <div className="col-md-12 gia-soc-title">
        ...
        <span className="ml-2">ĐỒ CHƠI VÀ SỞ THÍCH</span>
      </div>
    </div>
...
const connected = connect(mapStateToProps)(MenuHideRightDoChoi);
export { connected as MenuHideRightDoChoi } 