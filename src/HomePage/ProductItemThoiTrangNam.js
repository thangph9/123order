...
class ProductItemThoiTrangNam extends React.Component {
    constructor(props) {
        super(props);
        this.state={
...
const connected = connect(mapStateToProps)(ProductItemThoiTrangNam);
export { connected as ProductItemThoiTrangNam } 