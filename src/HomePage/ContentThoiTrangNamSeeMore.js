...
class ContentThoiTrangNamSeeMore extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
...
const connected = connect(mapStateToProps)(ContentThoiTrangNamSeeMore);
export { connected as ContentThoiTrangNamSeeMore } 