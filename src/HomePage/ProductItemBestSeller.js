...
class ProductItemBestSeller extends React.Component {
    constructor(props) {
        super(props);
        this.state={
...
const connected = connect(mapStateToProps)(ProductItemBestSeller);
export { connected as ProductItemBestSeller } 