...
class MenuStoreSucKhoe extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="storeSucKhoe" className="tabcontent" style={{ display: 'none' }}>
...
const connected = connect(mapStateToProps)(MenuStoreSucKhoe);
export { connected as MenuStoreSucKhoe } 