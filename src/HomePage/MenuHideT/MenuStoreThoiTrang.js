...
class MenuStoreThoiTrang extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="storeThoiTrang" className="tabcontent" style={{ display: 'none' }}>
...
const connected = connect(mapStateToProps)(MenuStoreThoiTrang);
export { connected as MenuStoreThoiTrang } 