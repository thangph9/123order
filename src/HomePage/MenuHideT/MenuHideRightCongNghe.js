...
class MenuHideRightCongNghe extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="storeCongNghe" className="tabcontent" style={{ display: 'none' }}>
...
const connected = connect(mapStateToProps)(MenuHideRightCongNghe);
export { connected as MenuHideRightCongNghe } 