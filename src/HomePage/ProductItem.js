            ...
            <div className="col-md mt-2 px-2" style={{display:display,marginBottom:'8px'}}>
                <div className="card" style={{width:'212px',height:'402px'}}>
                    <div className="hovereffect" style={{width:'210px',height:'210px'}}>
                        <span style={{display:'block',background:'red',color: '#fff',fontWeight: 700,borderRadius: '5px',fontSize:'12px',padding:'3px 6px',width: '44px',height:'24px',right: '10px',top: '10px',position: 'absolute',zIndex: 2}}>-20%</span>
