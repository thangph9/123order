...
class ContentThoiTrangNuSeeMore extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
...
const connected = connect(mapStateToProps)(ContentThoiTrangNuSeeMore);
export { connected as ContentThoiTrangNuSeeMore } 