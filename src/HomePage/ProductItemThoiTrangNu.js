...
class ProductItemThoiTrangNu extends React.Component {
    constructor(props) {
        super(props);
        this.state={
...
const connected = connect(mapStateToProps)(ProductItemThoiTrangNu);
export { connected as ProductItemThoiTrangNu } 