...
class MenuHideDoCo extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        ...
        return (
            <div id="doCo" className="tabcontent" style={{ display: 'none' }}>
...
<div className="row">
  <div className="col-md-12 gia-soc-title">
    ...
    <span className="ml-2">Đồ Cổ, BỘ Sưu Tập</span>
  </div>
</div>
...
const connected = connect(mapStateToProps)(MenuHideDoCo);
export { connected as MenuHideDoCo } 