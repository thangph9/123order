...
class MenuHideRightDongHo extends React.Component {
    ...
    render() {
        ...
        return (
            <div id="dongHo" className="tabcontent" style={{ display: 'none' }}>
  ...
  <div className="col-md-8">
    <div className="row">
      <div className="col-md-12 gia-soc-title">
        ...
        <span className="ml-2">ĐỒNG HỒ</span>
      </div>
    </div>
...
const connected = connect(mapStateToProps)(MenuHideRightDongHo);
export { connected as MenuHideRightDongHo } 