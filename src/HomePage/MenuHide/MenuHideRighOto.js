...
class MenuHideRighOto extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
    ...
    render() {
        return (
            <div id="oTo" className="tabcontent" style={{ display: 'none' }}>
  ...
  <div className="col-md-8">
    <div className="row">
      <div className="col-md-12 gia-soc-title">
        ...
        <span className="ml-2">PHỤ KIỆN, PHỤ TÙNG Ô TÔ</span>
      </div>
    </div>
    ...
    <div className="row mt-2">
      ...
      <div className="col-md-4">
        <ul>
          ...
          <li>
            <Link to="/danh-muc-ebay" className="ml-2 text-dark  list-item">Máy xay</Link>
          </li>
          <li>    
...
const connected = connect(mapStateToProps)(MenuHideRighOto);
export { connected as MenuHideRighOto } 