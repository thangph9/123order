...
class ContentDealSeeMoreBestSeller extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            login: true,
...
const connected = connect(mapStateToProps)(ContentDealSeeMoreBestSeller);
export { connected as ContentDealSeeMoreBestSeller } 