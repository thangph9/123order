                    ...
                    <div className="extra-info__extra-info___HmKpD extra-info__col-md-6___3ZC3K extra-info__col-sm-12___2y7dc">
                      ...
                      <div className="extra-info__info-text___CTc2n">
                        ...
                        <ul className="extra-info__text-list-ul___6CagB">
                          <li className="extra-info__text-list___21vcj">Leflair chỉ làm việc trực tiếp với các thương hiệu và nhà phân phối chính thức</li>
                          <li className="extra-info__text-list___21vcj">Leflair kiểm soát chặt chẽ quy trình hàng hóa được hợp pháp giao dịch, nhập khẩu và khai thuế</li>
                          <li className="extra-info__text-list___21vcj">Leflair vận hành nghiêm ngặt quy trình kiểm soát chất lượng của từng sản phẩm trước mỗi chương trình ưu đãi</li>
                        </ul>
                      </div>
                    </div>
                    <div className="extra-info__extra-info___HmKpD extra-info__col-md-6___3ZC3K extra-info__col-sm-12___2y7dc">
                      ...
                      <div className="extra-info__info-text___CTc2n">
                        ...
                        <ul className="extra-info__table-group___1xJ6Q">
                          <li>
                            ...
                            <div className="extra-info__item-text___28eEv">Liên hệ bộ phận CSKH Leflair</div>
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            <div className="extra-info__item-text___28eEv">Leflair xác nhận sản phẩm và hóa đơn</div>
                          </li>
                          <li>
